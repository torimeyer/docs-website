...
To create a new domain from the authentication domain UI page, click <DNT>**Create authentication domain**</DNT>. To delete an authentication domain, click the three dots next to the authentication domain you want to delete and select "Remove". For more about the configuration options, keep reading.
