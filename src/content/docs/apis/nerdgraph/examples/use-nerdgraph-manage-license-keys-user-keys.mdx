...
You can use the [API keys UI](https://one.newrelic.com/launcher/api-keys-ui.api-keys-launcher) to create and delete keys. Alternatively, you can use [NerdGraph](/docs/introduction-new-relic-graphql)'s `ApiAccess` field to programmatically create and manage the following types of keys:
...
* You can also [create and delete user keys using the UI.](/docs/apis/get-started/intro-apis/types-new-relic-api-keys#personal-api-key)
